...
class ATTAArgs(TreeTap):
    ...
    gpu_clustering: bool = True #: GPU flag for the torch clustering implementation.
...
class CommonArgs(TreeTap):
    ...
    """
    # /root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/PACS/SimATTA.yaml
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/SimATTA.yaml' #: (Required) The path for the config file.
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Entropy.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Tent.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Kmeans.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Random.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/EATA.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Coreset.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray/Entropy.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray/SimATTA.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray/ATMO.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000_new/ATMO.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Coreset.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/badge.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/HAM10000/Cotta.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Camelyon/badge.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray/Cotta.yaml' 
    config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Camelyon/ATMO.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Camelyon/EATA.yaml'
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray/ATMO.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray/ATMO.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs/TTA_configs/Xray_N/SimATTA.yaml' 
    # config_path: pathlib.Path = '/root/wangfan/ATTA-main/ATTA-main/configs//TTA_configs/Camelyon/SimATTA.yaml' 
    # # config_path: pathlib.Path = None
    
    task: Literal['train', 'test', 'adapt'] = 'train'  #: Running mode. Allowed: 'train' and 'test'.
    random_seed: int = 0  #: Fixed random seed for reproducibility.
    exp_round: int = 1 #: Current experiment round.
    pytest: bool = None
    ...
    gpu_idx: int = 0  #: GPU index.
    device = 0  #: Automatically generated by choosing gpu_idx.
